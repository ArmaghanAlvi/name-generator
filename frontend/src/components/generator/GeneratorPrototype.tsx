      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-8 lg:grid-cols-[260px_1fr]">
        <aside className="h-fit rounded-3xl border border-slate-200 bg-white p-5">
          ...
          >
            ...
            <option value={6}>6 expansions</option>
            <option value={7}>7 expansions</option>
            <option value={8}>8 expansions</option>
            <option value={9}>9 expansions</option>
            <option value={10}>10 expansions</option>
          </select>
